...
// checks if the ValuationsNREITDIRECTRatios type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ValuationsNREITDIRECTRatios{}

// ValuationsNREITDIRECTRatios struct for ValuationsNREITDIRECTRatios
type ValuationsNREITDIRECTRatios struct {
...
func NewValuationsNREITDIRECTRatios() *ValuationsNREITDIRECTRatios {
	this := ValuationsNREITDIRECTRatios{}
	return &this
}
...
// and a boolean to check if the value has been set.
func (o *ValuationsNREITDIRECTRatios) GetCapexToRevenueOk() (*float32, bool) {
	if o == nil || IsNil(o.CapexToRevenue) {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *ValuationsNREITDIRECTRatios) GetEbitdaMarginOk() (*float32, bool) {
	if o == nil || IsNil(o.EbitdaMargin) {
		return nil, false
	}
...
func (o *ValuationsNREITDIRECTRatios) HasGrossMargin() bool {
	if o != nil && !IsNil(o.GrossMargin) {
		return true
	}
...
func (o *ValuationsNREITDIRECTRatios) GetInventoryTurnover() float32 {
...
// and a boolean to check if the value has been set.
func (o *ValuationsNREITDIRECTRatios) GetNetMarginOk() (*float32, bool) {
	if o == nil || IsNil(o.NetMargin) {
		return nil, false
	}
...
func (o *ValuationsNREITDIRECTRatios) SetPayout(v float32) {
	o.Payout = &v
}
...
func (o *ValuationsNREITDIRECTRatios) HasReceivablesTurnover() bool {
	if o != nil && !IsNil(o.ReceivablesTurnover) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *ValuationsNREITDIRECTRatios) GetRoceOk() (*float32, bool) {
	if o == nil || IsNil(o.Roce) {
		return nil, false
	}
	return o.Roce, true
...
func (o *ValuationsNREITDIRECTRatios) SetRoeAdj(v float32) {
	o.RoeAdj = &v
}
...
func (o ValuationsNREITDIRECTRatios) MarshalJSON() ([]byte, error) {
...
func (o ValuationsNREITDIRECTRatios) ToMap() (map[string]interface{}, error) {
...
type NullableValuationsNREITDIRECTRatios struct {
	value *ValuationsNREITDIRECTRatios
	isSet bool
}

func (v NullableValuationsNREITDIRECTRatios) Get() *ValuationsNREITDIRECTRatios {
	return v.value
}

func (v *NullableValuationsNREITDIRECTRatios) Set(val *ValuationsNREITDIRECTRatios) {
	v.value = val
	v.isSet = true
}

func (v NullableValuationsNREITDIRECTRatios) IsSet() bool {
	return v.isSet
}

func (v *NullableValuationsNREITDIRECTRatios) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableValuationsNREITDIRECTRatios(val *ValuationsNREITDIRECTRatios) *NullableValuationsNREITDIRECTRatios {
	return &NullableValuationsNREITDIRECTRatios{value: val, isSet: true}
}

func (v NullableValuationsNREITDIRECTRatios) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableValuationsNREITDIRECTRatios) UnmarshalJSON(src []byte) error {
	v.isSet = true
