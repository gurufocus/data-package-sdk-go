...
// checks if the ValuationsNREITDIRECTValuationRatios type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ValuationsNREITDIRECTValuationRatios{}

// ValuationsNREITDIRECTValuationRatios struct for ValuationsNREITDIRECTValuationRatios
type ValuationsNREITDIRECTValuationRatios struct {
...
func NewValuationsNREITDIRECTValuationRatios() *ValuationsNREITDIRECTValuationRatios {
	this := ValuationsNREITDIRECTValuationRatios{}
	return &this
}
...
func (o ValuationsNREITDIRECTValuationRatios) MarshalJSON() ([]byte, error) {
...
func (o ValuationsNREITDIRECTValuationRatios) ToMap() (map[string]interface{}, error) {
...
type NullableValuationsNREITDIRECTValuationRatios struct {
	value *ValuationsNREITDIRECTValuationRatios
	isSet bool
}

func (v NullableValuationsNREITDIRECTValuationRatios) Get() *ValuationsNREITDIRECTValuationRatios {
	return v.value
}

func (v *NullableValuationsNREITDIRECTValuationRatios) Set(val *ValuationsNREITDIRECTValuationRatios) {
	v.value = val
	v.isSet = true
}

func (v NullableValuationsNREITDIRECTValuationRatios) IsSet() bool {
	return v.isSet
}

func (v *NullableValuationsNREITDIRECTValuationRatios) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableValuationsNREITDIRECTValuationRatios(val *ValuationsNREITDIRECTValuationRatios) *NullableValuationsNREITDIRECTValuationRatios {
	return &NullableValuationsNREITDIRECTValuationRatios{value: val, isSet: true}
}

func (v NullableValuationsNREITDIRECTValuationRatios) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableValuationsNREITDIRECTValuationRatios) UnmarshalJSON(src []byte) error {
	v.isSet = true
