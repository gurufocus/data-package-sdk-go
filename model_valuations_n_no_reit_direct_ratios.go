...
// checks if the ValuationsNNOREITDIRECTRatios type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ValuationsNNOREITDIRECTRatios{}

// ValuationsNNOREITDIRECTRatios struct for ValuationsNNOREITDIRECTRatios
type ValuationsNNOREITDIRECTRatios struct {
...
func NewValuationsNNOREITDIRECTRatios() *ValuationsNNOREITDIRECTRatios {
	this := ValuationsNNOREITDIRECTRatios{}
	return &this
}
...
func (o ValuationsNNOREITDIRECTRatios) MarshalJSON() ([]byte, error) {
...
func (o ValuationsNNOREITDIRECTRatios) ToMap() (map[string]interface{}, error) {
...
type NullableValuationsNNOREITDIRECTRatios struct {
	value *ValuationsNNOREITDIRECTRatios
	isSet bool
}

func (v NullableValuationsNNOREITDIRECTRatios) Get() *ValuationsNNOREITDIRECTRatios {
	return v.value
}

func (v *NullableValuationsNNOREITDIRECTRatios) Set(val *ValuationsNNOREITDIRECTRatios) {
	v.value = val
	v.isSet = true
}

func (v NullableValuationsNNOREITDIRECTRatios) IsSet() bool {
	return v.isSet
}

func (v *NullableValuationsNNOREITDIRECTRatios) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableValuationsNNOREITDIRECTRatios(val *ValuationsNNOREITDIRECTRatios) *NullableValuationsNNOREITDIRECTRatios {
	return &NullableValuationsNNOREITDIRECTRatios{value: val, isSet: true}
}

func (v NullableValuationsNNOREITDIRECTRatios) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableValuationsNNOREITDIRECTRatios) UnmarshalJSON(src []byte) error {
	v.isSet = true
