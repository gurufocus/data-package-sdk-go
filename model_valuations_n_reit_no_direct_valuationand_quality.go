...
// checks if the ValuationsNREITNODIRECTValuationandQuality type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ValuationsNREITNODIRECTValuationandQuality{}

// ValuationsNREITNODIRECTValuationandQuality struct for ValuationsNREITNODIRECTValuationandQuality
type ValuationsNREITNODIRECTValuationandQuality struct {
...
func NewValuationsNREITNODIRECTValuationandQuality() *ValuationsNREITNODIRECTValuationandQuality {
	this := ValuationsNREITNODIRECTValuationandQuality{}
	return &this
}
...
func (o ValuationsNREITNODIRECTValuationandQuality) MarshalJSON() ([]byte, error) {
...
func (o ValuationsNREITNODIRECTValuationandQuality) ToMap() (map[string]interface{}, error) {
...
type NullableValuationsNREITNODIRECTValuationandQuality struct {
	value *ValuationsNREITNODIRECTValuationandQuality
	isSet bool
}

func (v NullableValuationsNREITNODIRECTValuationandQuality) Get() *ValuationsNREITNODIRECTValuationandQuality {
	return v.value
}

func (v *NullableValuationsNREITNODIRECTValuationandQuality) Set(val *ValuationsNREITNODIRECTValuationandQuality) {
	v.value = val
	v.isSet = true
}

func (v NullableValuationsNREITNODIRECTValuationandQuality) IsSet() bool {
	return v.isSet
}

func (v *NullableValuationsNREITNODIRECTValuationandQuality) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableValuationsNREITNODIRECTValuationandQuality(val *ValuationsNREITNODIRECTValuationandQuality) *NullableValuationsNREITNODIRECTValuationandQuality {
	return &NullableValuationsNREITNODIRECTValuationandQuality{value: val, isSet: true}
}

func (v NullableValuationsNREITNODIRECTValuationandQuality) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableValuationsNREITNODIRECTValuationandQuality) UnmarshalJSON(src []byte) error {
	v.isSet = true
