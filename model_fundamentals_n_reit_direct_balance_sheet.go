...
// checks if the FundamentalsNREITDIRECTBalanceSheet type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FundamentalsNREITDIRECTBalanceSheet{}

// FundamentalsNREITDIRECTBalanceSheet struct for FundamentalsNREITDIRECTBalanceSheet
type FundamentalsNREITDIRECTBalanceSheet struct {
...
func NewFundamentalsNREITDIRECTBalanceSheet() *FundamentalsNREITDIRECTBalanceSheet {
	this := FundamentalsNREITDIRECTBalanceSheet{}
	return &this
}
...
func (o FundamentalsNREITDIRECTBalanceSheet) MarshalJSON() ([]byte, error) {
...
func (o FundamentalsNREITDIRECTBalanceSheet) ToMap() (map[string]interface{}, error) {
...
type NullableFundamentalsNREITDIRECTBalanceSheet struct {
	value *FundamentalsNREITDIRECTBalanceSheet
	isSet bool
}

func (v NullableFundamentalsNREITDIRECTBalanceSheet) Get() *FundamentalsNREITDIRECTBalanceSheet {
	return v.value
}

func (v *NullableFundamentalsNREITDIRECTBalanceSheet) Set(val *FundamentalsNREITDIRECTBalanceSheet) {
	v.value = val
	v.isSet = true
}

func (v NullableFundamentalsNREITDIRECTBalanceSheet) IsSet() bool {
	return v.isSet
}

func (v *NullableFundamentalsNREITDIRECTBalanceSheet) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFundamentalsNREITDIRECTBalanceSheet(val *FundamentalsNREITDIRECTBalanceSheet) *NullableFundamentalsNREITDIRECTBalanceSheet {
	return &NullableFundamentalsNREITDIRECTBalanceSheet{value: val, isSet: true}
}

func (v NullableFundamentalsNREITDIRECTBalanceSheet) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFundamentalsNREITDIRECTBalanceSheet) UnmarshalJSON(src []byte) error {
	v.isSet = true
