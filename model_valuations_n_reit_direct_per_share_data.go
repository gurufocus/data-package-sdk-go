...
// checks if the ValuationsNREITDIRECTPerShareData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ValuationsNREITDIRECTPerShareData{}

// ValuationsNREITDIRECTPerShareData struct for ValuationsNREITDIRECTPerShareData
type ValuationsNREITDIRECTPerShareData struct {
...
func NewValuationsNREITDIRECTPerShareData() *ValuationsNREITDIRECTPerShareData {
	this := ValuationsNREITDIRECTPerShareData{}
	return &this
}
...
func (o ValuationsNREITDIRECTPerShareData) MarshalJSON() ([]byte, error) {
...
func (o ValuationsNREITDIRECTPerShareData) ToMap() (map[string]interface{}, error) {
...
type NullableValuationsNREITDIRECTPerShareData struct {
	value *ValuationsNREITDIRECTPerShareData
	isSet bool
}

func (v NullableValuationsNREITDIRECTPerShareData) Get() *ValuationsNREITDIRECTPerShareData {
	return v.value
}

func (v *NullableValuationsNREITDIRECTPerShareData) Set(val *ValuationsNREITDIRECTPerShareData) {
	v.value = val
	v.isSet = true
}

func (v NullableValuationsNREITDIRECTPerShareData) IsSet() bool {
	return v.isSet
}

func (v *NullableValuationsNREITDIRECTPerShareData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableValuationsNREITDIRECTPerShareData(val *ValuationsNREITDIRECTPerShareData) *NullableValuationsNREITDIRECTPerShareData {
	return &NullableValuationsNREITDIRECTPerShareData{value: val, isSet: true}
}

func (v NullableValuationsNREITDIRECTPerShareData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableValuationsNREITDIRECTPerShareData) UnmarshalJSON(src []byte) error {
	v.isSet = true
