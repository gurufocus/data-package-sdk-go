...
// checks if the FundamentalsNREITNODIRECTBalanceSheet type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FundamentalsNREITNODIRECTBalanceSheet{}

// FundamentalsNREITNODIRECTBalanceSheet struct for FundamentalsNREITNODIRECTBalanceSheet
type FundamentalsNREITNODIRECTBalanceSheet struct {
...
func NewFundamentalsNREITNODIRECTBalanceSheet() *FundamentalsNREITNODIRECTBalanceSheet {
	this := FundamentalsNREITNODIRECTBalanceSheet{}
	return &this
}
...
func (o FundamentalsNREITNODIRECTBalanceSheet) MarshalJSON() ([]byte, error) {
...
func (o FundamentalsNREITNODIRECTBalanceSheet) ToMap() (map[string]interface{}, error) {
...
type NullableFundamentalsNREITNODIRECTBalanceSheet struct {
	value *FundamentalsNREITNODIRECTBalanceSheet
	isSet bool
}

func (v NullableFundamentalsNREITNODIRECTBalanceSheet) Get() *FundamentalsNREITNODIRECTBalanceSheet {
	return v.value
}

func (v *NullableFundamentalsNREITNODIRECTBalanceSheet) Set(val *FundamentalsNREITNODIRECTBalanceSheet) {
	v.value = val
	v.isSet = true
}

func (v NullableFundamentalsNREITNODIRECTBalanceSheet) IsSet() bool {
	return v.isSet
}

func (v *NullableFundamentalsNREITNODIRECTBalanceSheet) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFundamentalsNREITNODIRECTBalanceSheet(val *FundamentalsNREITNODIRECTBalanceSheet) *NullableFundamentalsNREITNODIRECTBalanceSheet {
	return &NullableFundamentalsNREITNODIRECTBalanceSheet{value: val, isSet: true}
}

func (v NullableFundamentalsNREITNODIRECTBalanceSheet) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFundamentalsNREITNODIRECTBalanceSheet) UnmarshalJSON(src []byte) error {
	v.isSet = true
