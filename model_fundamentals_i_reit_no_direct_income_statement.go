...
// checks if the FundamentalsIREITNODIRECTIncomeStatement type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FundamentalsIREITNODIRECTIncomeStatement{}

// FundamentalsIREITNODIRECTIncomeStatement struct for FundamentalsIREITNODIRECTIncomeStatement
type FundamentalsIREITNODIRECTIncomeStatement struct {
...
func NewFundamentalsIREITNODIRECTIncomeStatement() *FundamentalsIREITNODIRECTIncomeStatement {
	this := FundamentalsIREITNODIRECTIncomeStatement{}
	return &this
}
...
func (o FundamentalsIREITNODIRECTIncomeStatement) MarshalJSON() ([]byte, error) {
...
func (o FundamentalsIREITNODIRECTIncomeStatement) ToMap() (map[string]interface{}, error) {
...
type NullableFundamentalsIREITNODIRECTIncomeStatement struct {
	value *FundamentalsIREITNODIRECTIncomeStatement
	isSet bool
}

func (v NullableFundamentalsIREITNODIRECTIncomeStatement) Get() *FundamentalsIREITNODIRECTIncomeStatement {
	return v.value
}

func (v *NullableFundamentalsIREITNODIRECTIncomeStatement) Set(val *FundamentalsIREITNODIRECTIncomeStatement) {
	v.value = val
	v.isSet = true
}

func (v NullableFundamentalsIREITNODIRECTIncomeStatement) IsSet() bool {
	return v.isSet
}

func (v *NullableFundamentalsIREITNODIRECTIncomeStatement) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFundamentalsIREITNODIRECTIncomeStatement(val *FundamentalsIREITNODIRECTIncomeStatement) *NullableFundamentalsIREITNODIRECTIncomeStatement {
	return &NullableFundamentalsIREITNODIRECTIncomeStatement{value: val, isSet: true}
}

func (v NullableFundamentalsIREITNODIRECTIncomeStatement) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFundamentalsIREITNODIRECTIncomeStatement) UnmarshalJSON(src []byte) error {
	v.isSet = true
