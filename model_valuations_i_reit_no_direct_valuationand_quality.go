...
// checks if the ValuationsIREITNODIRECTValuationandQuality type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ValuationsIREITNODIRECTValuationandQuality{}

// ValuationsIREITNODIRECTValuationandQuality struct for ValuationsIREITNODIRECTValuationandQuality
type ValuationsIREITNODIRECTValuationandQuality struct {
...
func NewValuationsIREITNODIRECTValuationandQuality() *ValuationsIREITNODIRECTValuationandQuality {
	this := ValuationsIREITNODIRECTValuationandQuality{}
	return &this
}
...
func (o ValuationsIREITNODIRECTValuationandQuality) MarshalJSON() ([]byte, error) {
...
func (o ValuationsIREITNODIRECTValuationandQuality) ToMap() (map[string]interface{}, error) {
...
type NullableValuationsIREITNODIRECTValuationandQuality struct {
	value *ValuationsIREITNODIRECTValuationandQuality
	isSet bool
}

func (v NullableValuationsIREITNODIRECTValuationandQuality) Get() *ValuationsIREITNODIRECTValuationandQuality {
	return v.value
}

func (v *NullableValuationsIREITNODIRECTValuationandQuality) Set(val *ValuationsIREITNODIRECTValuationandQuality) {
	v.value = val
	v.isSet = true
}

func (v NullableValuationsIREITNODIRECTValuationandQuality) IsSet() bool {
	return v.isSet
}

func (v *NullableValuationsIREITNODIRECTValuationandQuality) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableValuationsIREITNODIRECTValuationandQuality(val *ValuationsIREITNODIRECTValuationandQuality) *NullableValuationsIREITNODIRECTValuationandQuality {
	return &NullableValuationsIREITNODIRECTValuationandQuality{value: val, isSet: true}
}

func (v NullableValuationsIREITNODIRECTValuationandQuality) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableValuationsIREITNODIRECTValuationandQuality) UnmarshalJSON(src []byte) error {
	v.isSet = true
