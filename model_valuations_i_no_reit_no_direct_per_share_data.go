...
// checks if the ValuationsINOREITNODIRECTPerShareData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ValuationsINOREITNODIRECTPerShareData{}

// ValuationsINOREITNODIRECTPerShareData struct for ValuationsINOREITNODIRECTPerShareData
type ValuationsINOREITNODIRECTPerShareData struct {
...
func NewValuationsINOREITNODIRECTPerShareData() *ValuationsINOREITNODIRECTPerShareData {
	this := ValuationsINOREITNODIRECTPerShareData{}
	return &this
}
...
func (o ValuationsINOREITNODIRECTPerShareData) MarshalJSON() ([]byte, error) {
...
func (o ValuationsINOREITNODIRECTPerShareData) ToMap() (map[string]interface{}, error) {
...
type NullableValuationsINOREITNODIRECTPerShareData struct {
	value *ValuationsINOREITNODIRECTPerShareData
	isSet bool
}

func (v NullableValuationsINOREITNODIRECTPerShareData) Get() *ValuationsINOREITNODIRECTPerShareData {
	return v.value
}

func (v *NullableValuationsINOREITNODIRECTPerShareData) Set(val *ValuationsINOREITNODIRECTPerShareData) {
	v.value = val
	v.isSet = true
}

func (v NullableValuationsINOREITNODIRECTPerShareData) IsSet() bool {
	return v.isSet
}

func (v *NullableValuationsINOREITNODIRECTPerShareData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableValuationsINOREITNODIRECTPerShareData(val *ValuationsINOREITNODIRECTPerShareData) *NullableValuationsINOREITNODIRECTPerShareData {
	return &NullableValuationsINOREITNODIRECTPerShareData{value: val, isSet: true}
}

func (v NullableValuationsINOREITNODIRECTPerShareData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableValuationsINOREITNODIRECTPerShareData) UnmarshalJSON(src []byte) error {
	v.isSet = true
