...
// checks if the FundamentalsIREITNODIRECTBasicInformation type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FundamentalsIREITNODIRECTBasicInformation{}

// FundamentalsIREITNODIRECTBasicInformation struct for FundamentalsIREITNODIRECTBasicInformation
type FundamentalsIREITNODIRECTBasicInformation struct {
...
func NewFundamentalsIREITNODIRECTBasicInformation() *FundamentalsIREITNODIRECTBasicInformation {
	this := FundamentalsIREITNODIRECTBasicInformation{}
	return &this
}
...
func (o FundamentalsIREITNODIRECTBasicInformation) MarshalJSON() ([]byte, error) {
...
func (o FundamentalsIREITNODIRECTBasicInformation) ToMap() (map[string]interface{}, error) {
...
type NullableFundamentalsIREITNODIRECTBasicInformation struct {
	value *FundamentalsIREITNODIRECTBasicInformation
	isSet bool
}

func (v NullableFundamentalsIREITNODIRECTBasicInformation) Get() *FundamentalsIREITNODIRECTBasicInformation {
	return v.value
}

func (v *NullableFundamentalsIREITNODIRECTBasicInformation) Set(val *FundamentalsIREITNODIRECTBasicInformation) {
	v.value = val
	v.isSet = true
}

func (v NullableFundamentalsIREITNODIRECTBasicInformation) IsSet() bool {
	return v.isSet
}

func (v *NullableFundamentalsIREITNODIRECTBasicInformation) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFundamentalsIREITNODIRECTBasicInformation(val *FundamentalsIREITNODIRECTBasicInformation) *NullableFundamentalsIREITNODIRECTBasicInformation {
	return &NullableFundamentalsIREITNODIRECTBasicInformation{value: val, isSet: true}
}

func (v NullableFundamentalsIREITNODIRECTBasicInformation) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFundamentalsIREITNODIRECTBasicInformation) UnmarshalJSON(src []byte) error {
	v.isSet = true
