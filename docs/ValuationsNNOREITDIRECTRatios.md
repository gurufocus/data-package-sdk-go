...
**CapexToOperatingIncome** | Pointer to **float32** |  | [optional] 
**CapexToRevenue** | Pointer to **float32** |  | [optional] 
**CashConversionCycle** | Pointer to **float32** | Cash Conversion Cycle is one of several measures of management effectiveness. It equals Days Sales Outstanding + Days Inventory - Days Payable. | [optional] 
**CostOfGoodsSoldToRevenue** | Pointer to **float32** | The ratio of cost of goods sold to sales | [optional] 
...
**DaysSalesOutstanding** | Pointer to **float32** | Days sales outstanding (DSO) is a measure of the average number of days that it takes a company to collect payment after a sale has been made. | [optional] 
...
**GrossProfitToAsset** | Pointer to **float32** | The ratio of a company&#39;s gross profit to total assets | [optional] 
**InventoryToRevenue** | Pointer to **float32** | The ratio of total inventory to total revenues | [optional] 
...
**Rd2rev** | Pointer to **float32** |  | [optional] 
...
`func (o *ValuationsNNOREITDIRECTRatios) GetCapexToOperatingCashFlow() float32`
...
`func (o *ValuationsNNOREITDIRECTRatios) SetDaysPayable(v float32)`
...
`func (o *ValuationsNNOREITDIRECTRatios) HasDebtToAsset() bool`
...
`func (o *ValuationsNNOREITDIRECTRatios) GetDegreeOfOperatingLeverage() float32`
...
`func (o *ValuationsNNOREITDIRECTRatios) GetEffectiveInterestRateOk() (*float32, bool)`
...
`func (o *ValuationsNNOREITDIRECTRatios) SetReturnOnTangibleAsset(v float32)`
...
`func (o *ValuationsNNOREITDIRECTRatios) HasRoa() bool`
...
`func (o *ValuationsNNOREITDIRECTRatios) HasRore5y() bool`
