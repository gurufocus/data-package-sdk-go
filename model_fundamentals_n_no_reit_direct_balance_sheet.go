...
// checks if the FundamentalsNNOREITDIRECTBalanceSheet type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FundamentalsNNOREITDIRECTBalanceSheet{}

// FundamentalsNNOREITDIRECTBalanceSheet struct for FundamentalsNNOREITDIRECTBalanceSheet
type FundamentalsNNOREITDIRECTBalanceSheet struct {
...
func NewFundamentalsNNOREITDIRECTBalanceSheet() *FundamentalsNNOREITDIRECTBalanceSheet {
	this := FundamentalsNNOREITDIRECTBalanceSheet{}
	return &this
}
...
func (o FundamentalsNNOREITDIRECTBalanceSheet) MarshalJSON() ([]byte, error) {
...
func (o FundamentalsNNOREITDIRECTBalanceSheet) ToMap() (map[string]interface{}, error) {
...
type NullableFundamentalsNNOREITDIRECTBalanceSheet struct {
	value *FundamentalsNNOREITDIRECTBalanceSheet
	isSet bool
}

func (v NullableFundamentalsNNOREITDIRECTBalanceSheet) Get() *FundamentalsNNOREITDIRECTBalanceSheet {
	return v.value
}

func (v *NullableFundamentalsNNOREITDIRECTBalanceSheet) Set(val *FundamentalsNNOREITDIRECTBalanceSheet) {
	v.value = val
	v.isSet = true
}

func (v NullableFundamentalsNNOREITDIRECTBalanceSheet) IsSet() bool {
	return v.isSet
}

func (v *NullableFundamentalsNNOREITDIRECTBalanceSheet) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFundamentalsNNOREITDIRECTBalanceSheet(val *FundamentalsNNOREITDIRECTBalanceSheet) *NullableFundamentalsNNOREITDIRECTBalanceSheet {
	return &NullableFundamentalsNNOREITDIRECTBalanceSheet{value: val, isSet: true}
}

func (v NullableFundamentalsNNOREITDIRECTBalanceSheet) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFundamentalsNNOREITDIRECTBalanceSheet) UnmarshalJSON(src []byte) error {
	v.isSet = true
