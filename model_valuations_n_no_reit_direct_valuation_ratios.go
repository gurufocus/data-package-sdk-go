...
// checks if the ValuationsNNOREITDIRECTValuationRatios type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ValuationsNNOREITDIRECTValuationRatios{}

// ValuationsNNOREITDIRECTValuationRatios struct for ValuationsNNOREITDIRECTValuationRatios
type ValuationsNNOREITDIRECTValuationRatios struct {
...
func NewValuationsNNOREITDIRECTValuationRatios() *ValuationsNNOREITDIRECTValuationRatios {
	this := ValuationsNNOREITDIRECTValuationRatios{}
	return &this
}
...
func (o ValuationsNNOREITDIRECTValuationRatios) MarshalJSON() ([]byte, error) {
...
func (o ValuationsNNOREITDIRECTValuationRatios) ToMap() (map[string]interface{}, error) {
...
type NullableValuationsNNOREITDIRECTValuationRatios struct {
	value *ValuationsNNOREITDIRECTValuationRatios
	isSet bool
}

func (v NullableValuationsNNOREITDIRECTValuationRatios) Get() *ValuationsNNOREITDIRECTValuationRatios {
	return v.value
}

func (v *NullableValuationsNNOREITDIRECTValuationRatios) Set(val *ValuationsNNOREITDIRECTValuationRatios) {
	v.value = val
	v.isSet = true
}

func (v NullableValuationsNNOREITDIRECTValuationRatios) IsSet() bool {
	return v.isSet
}

func (v *NullableValuationsNNOREITDIRECTValuationRatios) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableValuationsNNOREITDIRECTValuationRatios(val *ValuationsNNOREITDIRECTValuationRatios) *NullableValuationsNNOREITDIRECTValuationRatios {
	return &NullableValuationsNNOREITDIRECTValuationRatios{value: val, isSet: true}
}

func (v NullableValuationsNNOREITDIRECTValuationRatios) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableValuationsNNOREITDIRECTValuationRatios) UnmarshalJSON(src []byte) error {
	v.isSet = true
