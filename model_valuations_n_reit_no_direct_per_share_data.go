...
// checks if the ValuationsNREITNODIRECTPerShareData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ValuationsNREITNODIRECTPerShareData{}

// ValuationsNREITNODIRECTPerShareData struct for ValuationsNREITNODIRECTPerShareData
type ValuationsNREITNODIRECTPerShareData struct {
...
func NewValuationsNREITNODIRECTPerShareData() *ValuationsNREITNODIRECTPerShareData {
	this := ValuationsNREITNODIRECTPerShareData{}
	return &this
}
...
func (o ValuationsNREITNODIRECTPerShareData) MarshalJSON() ([]byte, error) {
...
func (o ValuationsNREITNODIRECTPerShareData) ToMap() (map[string]interface{}, error) {
...
type NullableValuationsNREITNODIRECTPerShareData struct {
	value *ValuationsNREITNODIRECTPerShareData
	isSet bool
}

func (v NullableValuationsNREITNODIRECTPerShareData) Get() *ValuationsNREITNODIRECTPerShareData {
	return v.value
}

func (v *NullableValuationsNREITNODIRECTPerShareData) Set(val *ValuationsNREITNODIRECTPerShareData) {
	v.value = val
	v.isSet = true
}

func (v NullableValuationsNREITNODIRECTPerShareData) IsSet() bool {
	return v.isSet
}

func (v *NullableValuationsNREITNODIRECTPerShareData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableValuationsNREITNODIRECTPerShareData(val *ValuationsNREITNODIRECTPerShareData) *NullableValuationsNREITNODIRECTPerShareData {
	return &NullableValuationsNREITNODIRECTPerShareData{value: val, isSet: true}
}

func (v NullableValuationsNREITNODIRECTPerShareData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableValuationsNREITNODIRECTPerShareData) UnmarshalJSON(src []byte) error {
	v.isSet = true
