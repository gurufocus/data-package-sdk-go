...
// checks if the FundamentalsNNOREITNODIRECTIncomeStatement type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FundamentalsNNOREITNODIRECTIncomeStatement{}

// FundamentalsNNOREITNODIRECTIncomeStatement struct for FundamentalsNNOREITNODIRECTIncomeStatement
type FundamentalsNNOREITNODIRECTIncomeStatement struct {
...
func NewFundamentalsNNOREITNODIRECTIncomeStatement() *FundamentalsNNOREITNODIRECTIncomeStatement {
	this := FundamentalsNNOREITNODIRECTIncomeStatement{}
	return &this
}
...
func (o FundamentalsNNOREITNODIRECTIncomeStatement) MarshalJSON() ([]byte, error) {
...
func (o FundamentalsNNOREITNODIRECTIncomeStatement) ToMap() (map[string]interface{}, error) {
...
type NullableFundamentalsNNOREITNODIRECTIncomeStatement struct {
	value *FundamentalsNNOREITNODIRECTIncomeStatement
	isSet bool
}

func (v NullableFundamentalsNNOREITNODIRECTIncomeStatement) Get() *FundamentalsNNOREITNODIRECTIncomeStatement {
	return v.value
}

func (v *NullableFundamentalsNNOREITNODIRECTIncomeStatement) Set(val *FundamentalsNNOREITNODIRECTIncomeStatement) {
	v.value = val
	v.isSet = true
}

func (v NullableFundamentalsNNOREITNODIRECTIncomeStatement) IsSet() bool {
	return v.isSet
}

func (v *NullableFundamentalsNNOREITNODIRECTIncomeStatement) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFundamentalsNNOREITNODIRECTIncomeStatement(val *FundamentalsNNOREITNODIRECTIncomeStatement) *NullableFundamentalsNNOREITNODIRECTIncomeStatement {
	return &NullableFundamentalsNNOREITNODIRECTIncomeStatement{value: val, isSet: true}
}

func (v NullableFundamentalsNNOREITNODIRECTIncomeStatement) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFundamentalsNNOREITNODIRECTIncomeStatement) UnmarshalJSON(src []byte) error {
	v.isSet = true
