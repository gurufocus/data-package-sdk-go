...
// checks if the ValuationsNNOREITNODIRECTRatios type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ValuationsNNOREITNODIRECTRatios{}

// ValuationsNNOREITNODIRECTRatios struct for ValuationsNNOREITNODIRECTRatios
type ValuationsNNOREITNODIRECTRatios struct {
...
func NewValuationsNNOREITNODIRECTRatios() *ValuationsNNOREITNODIRECTRatios {
	this := ValuationsNNOREITNODIRECTRatios{}
	return &this
}
...
func (o *ValuationsNNOREITNODIRECTRatios) GetCapexToOperatingCashFlow() float32 {
...
func (o *ValuationsNNOREITNODIRECTRatios) SetDaysPayable(v float32) {
	o.DaysPayable = &v
}
...
func (o *ValuationsNNOREITNODIRECTRatios) HasDebtToAsset() bool {
	if o != nil && !IsNil(o.DebtToAsset) {
		return true
	}
...
func (o *ValuationsNNOREITNODIRECTRatios) GetDegreeOfOperatingLeverage() float32 {
...
// and a boolean to check if the value has been set.
func (o *ValuationsNNOREITNODIRECTRatios) GetEffectiveInterestRateOk() (*float32, bool) {
	if o == nil || IsNil(o.EffectiveInterestRate) {
		return nil, false
	}
...
func (o *ValuationsNNOREITNODIRECTRatios) SetReturnOnTangibleAsset(v float32) {
...
func (o *ValuationsNNOREITNODIRECTRatios) HasRoa() bool {
	if o != nil && !IsNil(o.Roa) {
		return true
	}
...
func (o *ValuationsNNOREITNODIRECTRatios) HasRore5y() bool {
	if o != nil && !IsNil(o.Rore5y) {
		return true
	}
...
func (o ValuationsNNOREITNODIRECTRatios) MarshalJSON() ([]byte, error) {
...
func (o ValuationsNNOREITNODIRECTRatios) ToMap() (map[string]interface{}, error) {
...
type NullableValuationsNNOREITNODIRECTRatios struct {
	value *ValuationsNNOREITNODIRECTRatios
	isSet bool
}

func (v NullableValuationsNNOREITNODIRECTRatios) Get() *ValuationsNNOREITNODIRECTRatios {
	return v.value
}

func (v *NullableValuationsNNOREITNODIRECTRatios) Set(val *ValuationsNNOREITNODIRECTRatios) {
	v.value = val
	v.isSet = true
}

func (v NullableValuationsNNOREITNODIRECTRatios) IsSet() bool {
	return v.isSet
}

func (v *NullableValuationsNNOREITNODIRECTRatios) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableValuationsNNOREITNODIRECTRatios(val *ValuationsNNOREITNODIRECTRatios) *NullableValuationsNNOREITNODIRECTRatios {
	return &NullableValuationsNNOREITNODIRECTRatios{value: val, isSet: true}
}

func (v NullableValuationsNNOREITNODIRECTRatios) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableValuationsNNOREITNODIRECTRatios) UnmarshalJSON(src []byte) error {
	v.isSet = true
