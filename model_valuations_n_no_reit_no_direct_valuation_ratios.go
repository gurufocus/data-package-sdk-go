...
// checks if the ValuationsNNOREITNODIRECTValuationRatios type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ValuationsNNOREITNODIRECTValuationRatios{}

// ValuationsNNOREITNODIRECTValuationRatios struct for ValuationsNNOREITNODIRECTValuationRatios
type ValuationsNNOREITNODIRECTValuationRatios struct {
...
func NewValuationsNNOREITNODIRECTValuationRatios() *ValuationsNNOREITNODIRECTValuationRatios {
	this := ValuationsNNOREITNODIRECTValuationRatios{}
	return &this
}
...
func (o ValuationsNNOREITNODIRECTValuationRatios) MarshalJSON() ([]byte, error) {
...
func (o ValuationsNNOREITNODIRECTValuationRatios) ToMap() (map[string]interface{}, error) {
...
type NullableValuationsNNOREITNODIRECTValuationRatios struct {
	value *ValuationsNNOREITNODIRECTValuationRatios
	isSet bool
}

func (v NullableValuationsNNOREITNODIRECTValuationRatios) Get() *ValuationsNNOREITNODIRECTValuationRatios {
	return v.value
}

func (v *NullableValuationsNNOREITNODIRECTValuationRatios) Set(val *ValuationsNNOREITNODIRECTValuationRatios) {
	v.value = val
	v.isSet = true
}

func (v NullableValuationsNNOREITNODIRECTValuationRatios) IsSet() bool {
	return v.isSet
}

func (v *NullableValuationsNNOREITNODIRECTValuationRatios) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableValuationsNNOREITNODIRECTValuationRatios(val *ValuationsNNOREITNODIRECTValuationRatios) *NullableValuationsNNOREITNODIRECTValuationRatios {
	return &NullableValuationsNNOREITNODIRECTValuationRatios{value: val, isSet: true}
}

func (v NullableValuationsNNOREITNODIRECTValuationRatios) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableValuationsNNOREITNODIRECTValuationRatios) UnmarshalJSON(src []byte) error {
	v.isSet = true
