...
// checks if the StockFundamentalsBasicInformation type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StockFundamentalsBasicInformation{}

// StockFundamentalsBasicInformation struct for StockFundamentalsBasicInformation
type StockFundamentalsBasicInformation struct {
...
func NewStockFundamentalsBasicInformation() *StockFundamentalsBasicInformation {
	this := StockFundamentalsBasicInformation{}
	return &this
}
...
func (o StockFundamentalsBasicInformation) MarshalJSON() ([]byte, error) {
...
func (o StockFundamentalsBasicInformation) ToMap() (map[string]interface{}, error) {
...
type NullableStockFundamentalsBasicInformation struct {
	value *StockFundamentalsBasicInformation
	isSet bool
}

func (v NullableStockFundamentalsBasicInformation) Get() *StockFundamentalsBasicInformation {
	return v.value
}

func (v *NullableStockFundamentalsBasicInformation) Set(val *StockFundamentalsBasicInformation) {
	v.value = val
	v.isSet = true
}

func (v NullableStockFundamentalsBasicInformation) IsSet() bool {
	return v.isSet
}

func (v *NullableStockFundamentalsBasicInformation) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStockFundamentalsBasicInformation(val *StockFundamentalsBasicInformation) *NullableStockFundamentalsBasicInformation {
	return &NullableStockFundamentalsBasicInformation{value: val, isSet: true}
}

func (v NullableStockFundamentalsBasicInformation) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStockFundamentalsBasicInformation) UnmarshalJSON(src []byte) error {
	v.isSet = true
