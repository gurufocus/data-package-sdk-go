...
// checks if the FundamentalsNREITNODIRECTCashflowStatement type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FundamentalsNREITNODIRECTCashflowStatement{}

// FundamentalsNREITNODIRECTCashflowStatement struct for FundamentalsNREITNODIRECTCashflowStatement
type FundamentalsNREITNODIRECTCashflowStatement struct {
...
func NewFundamentalsNREITNODIRECTCashflowStatement() *FundamentalsNREITNODIRECTCashflowStatement {
	this := FundamentalsNREITNODIRECTCashflowStatement{}
	return &this
}
...
func (o FundamentalsNREITNODIRECTCashflowStatement) MarshalJSON() ([]byte, error) {
...
func (o FundamentalsNREITNODIRECTCashflowStatement) ToMap() (map[string]interface{}, error) {
...
type NullableFundamentalsNREITNODIRECTCashflowStatement struct {
	value *FundamentalsNREITNODIRECTCashflowStatement
	isSet bool
}

func (v NullableFundamentalsNREITNODIRECTCashflowStatement) Get() *FundamentalsNREITNODIRECTCashflowStatement {
	return v.value
}

func (v *NullableFundamentalsNREITNODIRECTCashflowStatement) Set(val *FundamentalsNREITNODIRECTCashflowStatement) {
	v.value = val
	v.isSet = true
}

func (v NullableFundamentalsNREITNODIRECTCashflowStatement) IsSet() bool {
	return v.isSet
}

func (v *NullableFundamentalsNREITNODIRECTCashflowStatement) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFundamentalsNREITNODIRECTCashflowStatement(val *FundamentalsNREITNODIRECTCashflowStatement) *NullableFundamentalsNREITNODIRECTCashflowStatement {
	return &NullableFundamentalsNREITNODIRECTCashflowStatement{value: val, isSet: true}
}

func (v NullableFundamentalsNREITNODIRECTCashflowStatement) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFundamentalsNREITNODIRECTCashflowStatement) UnmarshalJSON(src []byte) error {
	v.isSet = true
