...
// checks if the ValuationsNNOREITDIRECTBasicInformation type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ValuationsNNOREITDIRECTBasicInformation{}

// ValuationsNNOREITDIRECTBasicInformation struct for ValuationsNNOREITDIRECTBasicInformation
type ValuationsNNOREITDIRECTBasicInformation struct {
...
func NewValuationsNNOREITDIRECTBasicInformation() *ValuationsNNOREITDIRECTBasicInformation {
	this := ValuationsNNOREITDIRECTBasicInformation{}
	return &this
}
...
func (o ValuationsNNOREITDIRECTBasicInformation) MarshalJSON() ([]byte, error) {
...
func (o ValuationsNNOREITDIRECTBasicInformation) ToMap() (map[string]interface{}, error) {
...
type NullableValuationsNNOREITDIRECTBasicInformation struct {
	value *ValuationsNNOREITDIRECTBasicInformation
	isSet bool
}

func (v NullableValuationsNNOREITDIRECTBasicInformation) Get() *ValuationsNNOREITDIRECTBasicInformation {
	return v.value
}

func (v *NullableValuationsNNOREITDIRECTBasicInformation) Set(val *ValuationsNNOREITDIRECTBasicInformation) {
	v.value = val
	v.isSet = true
}

func (v NullableValuationsNNOREITDIRECTBasicInformation) IsSet() bool {
	return v.isSet
}

func (v *NullableValuationsNNOREITDIRECTBasicInformation) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableValuationsNNOREITDIRECTBasicInformation(val *ValuationsNNOREITDIRECTBasicInformation) *NullableValuationsNNOREITDIRECTBasicInformation {
	return &NullableValuationsNNOREITDIRECTBasicInformation{value: val, isSet: true}
}

func (v NullableValuationsNNOREITDIRECTBasicInformation) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableValuationsNNOREITDIRECTBasicInformation) UnmarshalJSON(src []byte) error {
	v.isSet = true
