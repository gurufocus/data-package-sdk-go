...
// checks if the FundamentalsINOREITNODIRECTCashflowStatement type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FundamentalsINOREITNODIRECTCashflowStatement{}

// FundamentalsINOREITNODIRECTCashflowStatement struct for FundamentalsINOREITNODIRECTCashflowStatement
type FundamentalsINOREITNODIRECTCashflowStatement struct {
...
func NewFundamentalsINOREITNODIRECTCashflowStatement() *FundamentalsINOREITNODIRECTCashflowStatement {
	this := FundamentalsINOREITNODIRECTCashflowStatement{}
	return &this
}
...
func (o FundamentalsINOREITNODIRECTCashflowStatement) MarshalJSON() ([]byte, error) {
...
func (o FundamentalsINOREITNODIRECTCashflowStatement) ToMap() (map[string]interface{}, error) {
...
type NullableFundamentalsINOREITNODIRECTCashflowStatement struct {
	value *FundamentalsINOREITNODIRECTCashflowStatement
	isSet bool
}

func (v NullableFundamentalsINOREITNODIRECTCashflowStatement) Get() *FundamentalsINOREITNODIRECTCashflowStatement {
	return v.value
}

func (v *NullableFundamentalsINOREITNODIRECTCashflowStatement) Set(val *FundamentalsINOREITNODIRECTCashflowStatement) {
	v.value = val
	v.isSet = true
}

func (v NullableFundamentalsINOREITNODIRECTCashflowStatement) IsSet() bool {
	return v.isSet
}

func (v *NullableFundamentalsINOREITNODIRECTCashflowStatement) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFundamentalsINOREITNODIRECTCashflowStatement(val *FundamentalsINOREITNODIRECTCashflowStatement) *NullableFundamentalsINOREITNODIRECTCashflowStatement {
	return &NullableFundamentalsINOREITNODIRECTCashflowStatement{value: val, isSet: true}
}

func (v NullableFundamentalsINOREITNODIRECTCashflowStatement) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFundamentalsINOREITNODIRECTCashflowStatement) UnmarshalJSON(src []byte) error {
	v.isSet = true
