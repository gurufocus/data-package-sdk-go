...
// checks if the FundamentalsINOREITNODIRECTBalanceSheet type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FundamentalsINOREITNODIRECTBalanceSheet{}

// FundamentalsINOREITNODIRECTBalanceSheet struct for FundamentalsINOREITNODIRECTBalanceSheet
type FundamentalsINOREITNODIRECTBalanceSheet struct {
...
func NewFundamentalsINOREITNODIRECTBalanceSheet() *FundamentalsINOREITNODIRECTBalanceSheet {
	this := FundamentalsINOREITNODIRECTBalanceSheet{}
	return &this
}
...
func (o FundamentalsINOREITNODIRECTBalanceSheet) MarshalJSON() ([]byte, error) {
...
func (o FundamentalsINOREITNODIRECTBalanceSheet) ToMap() (map[string]interface{}, error) {
...
type NullableFundamentalsINOREITNODIRECTBalanceSheet struct {
	value *FundamentalsINOREITNODIRECTBalanceSheet
	isSet bool
}

func (v NullableFundamentalsINOREITNODIRECTBalanceSheet) Get() *FundamentalsINOREITNODIRECTBalanceSheet {
	return v.value
}

func (v *NullableFundamentalsINOREITNODIRECTBalanceSheet) Set(val *FundamentalsINOREITNODIRECTBalanceSheet) {
	v.value = val
	v.isSet = true
}

func (v NullableFundamentalsINOREITNODIRECTBalanceSheet) IsSet() bool {
	return v.isSet
}

func (v *NullableFundamentalsINOREITNODIRECTBalanceSheet) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFundamentalsINOREITNODIRECTBalanceSheet(val *FundamentalsINOREITNODIRECTBalanceSheet) *NullableFundamentalsINOREITNODIRECTBalanceSheet {
	return &NullableFundamentalsINOREITNODIRECTBalanceSheet{value: val, isSet: true}
}

func (v NullableFundamentalsINOREITNODIRECTBalanceSheet) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFundamentalsINOREITNODIRECTBalanceSheet) UnmarshalJSON(src []byte) error {
	v.isSet = true
