...
// checks if the FundamentalsNNOREITDIRECTIncomeStatement type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FundamentalsNNOREITDIRECTIncomeStatement{}

// FundamentalsNNOREITDIRECTIncomeStatement struct for FundamentalsNNOREITDIRECTIncomeStatement
type FundamentalsNNOREITDIRECTIncomeStatement struct {
...
func NewFundamentalsNNOREITDIRECTIncomeStatement() *FundamentalsNNOREITDIRECTIncomeStatement {
	this := FundamentalsNNOREITDIRECTIncomeStatement{}
	return &this
}
...
func (o FundamentalsNNOREITDIRECTIncomeStatement) MarshalJSON() ([]byte, error) {
...
func (o FundamentalsNNOREITDIRECTIncomeStatement) ToMap() (map[string]interface{}, error) {
...
type NullableFundamentalsNNOREITDIRECTIncomeStatement struct {
	value *FundamentalsNNOREITDIRECTIncomeStatement
	isSet bool
}

func (v NullableFundamentalsNNOREITDIRECTIncomeStatement) Get() *FundamentalsNNOREITDIRECTIncomeStatement {
	return v.value
}

func (v *NullableFundamentalsNNOREITDIRECTIncomeStatement) Set(val *FundamentalsNNOREITDIRECTIncomeStatement) {
	v.value = val
	v.isSet = true
}

func (v NullableFundamentalsNNOREITDIRECTIncomeStatement) IsSet() bool {
	return v.isSet
}

func (v *NullableFundamentalsNNOREITDIRECTIncomeStatement) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFundamentalsNNOREITDIRECTIncomeStatement(val *FundamentalsNNOREITDIRECTIncomeStatement) *NullableFundamentalsNNOREITDIRECTIncomeStatement {
	return &NullableFundamentalsNNOREITDIRECTIncomeStatement{value: val, isSet: true}
}

func (v NullableFundamentalsNNOREITDIRECTIncomeStatement) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFundamentalsNNOREITDIRECTIncomeStatement) UnmarshalJSON(src []byte) error {
	v.isSet = true
