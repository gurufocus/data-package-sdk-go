...
// checks if the FundamentalsIREITNODIRECTCashflowStatement type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FundamentalsIREITNODIRECTCashflowStatement{}

// FundamentalsIREITNODIRECTCashflowStatement struct for FundamentalsIREITNODIRECTCashflowStatement
type FundamentalsIREITNODIRECTCashflowStatement struct {
...
func NewFundamentalsIREITNODIRECTCashflowStatement() *FundamentalsIREITNODIRECTCashflowStatement {
	this := FundamentalsIREITNODIRECTCashflowStatement{}
	return &this
}
...
func (o FundamentalsIREITNODIRECTCashflowStatement) MarshalJSON() ([]byte, error) {
...
func (o FundamentalsIREITNODIRECTCashflowStatement) ToMap() (map[string]interface{}, error) {
...
type NullableFundamentalsIREITNODIRECTCashflowStatement struct {
	value *FundamentalsIREITNODIRECTCashflowStatement
	isSet bool
}

func (v NullableFundamentalsIREITNODIRECTCashflowStatement) Get() *FundamentalsIREITNODIRECTCashflowStatement {
	return v.value
}

func (v *NullableFundamentalsIREITNODIRECTCashflowStatement) Set(val *FundamentalsIREITNODIRECTCashflowStatement) {
	v.value = val
	v.isSet = true
}

func (v NullableFundamentalsIREITNODIRECTCashflowStatement) IsSet() bool {
	return v.isSet
}

func (v *NullableFundamentalsIREITNODIRECTCashflowStatement) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFundamentalsIREITNODIRECTCashflowStatement(val *FundamentalsIREITNODIRECTCashflowStatement) *NullableFundamentalsIREITNODIRECTCashflowStatement {
	return &NullableFundamentalsIREITNODIRECTCashflowStatement{value: val, isSet: true}
}

func (v NullableFundamentalsIREITNODIRECTCashflowStatement) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFundamentalsIREITNODIRECTCashflowStatement) UnmarshalJSON(src []byte) error {
	v.isSet = true
