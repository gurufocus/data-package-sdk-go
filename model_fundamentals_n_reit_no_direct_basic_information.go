...
// checks if the FundamentalsNREITNODIRECTBasicInformation type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FundamentalsNREITNODIRECTBasicInformation{}

// FundamentalsNREITNODIRECTBasicInformation struct for FundamentalsNREITNODIRECTBasicInformation
type FundamentalsNREITNODIRECTBasicInformation struct {
...
func NewFundamentalsNREITNODIRECTBasicInformation() *FundamentalsNREITNODIRECTBasicInformation {
	this := FundamentalsNREITNODIRECTBasicInformation{}
	return &this
}
...
func (o FundamentalsNREITNODIRECTBasicInformation) MarshalJSON() ([]byte, error) {
...
func (o FundamentalsNREITNODIRECTBasicInformation) ToMap() (map[string]interface{}, error) {
...
type NullableFundamentalsNREITNODIRECTBasicInformation struct {
	value *FundamentalsNREITNODIRECTBasicInformation
	isSet bool
}

func (v NullableFundamentalsNREITNODIRECTBasicInformation) Get() *FundamentalsNREITNODIRECTBasicInformation {
	return v.value
}

func (v *NullableFundamentalsNREITNODIRECTBasicInformation) Set(val *FundamentalsNREITNODIRECTBasicInformation) {
	v.value = val
	v.isSet = true
}

func (v NullableFundamentalsNREITNODIRECTBasicInformation) IsSet() bool {
	return v.isSet
}

func (v *NullableFundamentalsNREITNODIRECTBasicInformation) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFundamentalsNREITNODIRECTBasicInformation(val *FundamentalsNREITNODIRECTBasicInformation) *NullableFundamentalsNREITNODIRECTBasicInformation {
	return &NullableFundamentalsNREITNODIRECTBasicInformation{value: val, isSet: true}
}

func (v NullableFundamentalsNREITNODIRECTBasicInformation) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFundamentalsNREITNODIRECTBasicInformation) UnmarshalJSON(src []byte) error {
	v.isSet = true
